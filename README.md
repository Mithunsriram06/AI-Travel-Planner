...
1. Prerequisites
Ensure you have Python 3.8 or higher installed on your system. You will also need a free API key from Google AI Studio.
...
Author: Mithun Sriram.V
B.Tech in Artificial Intelligence and Data Science, T.J.S. Engineering college
